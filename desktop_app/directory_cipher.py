...
def read_and_code(binary, cipher_instance, file_name, extension):
    ...
    writables_list = cipher_instance.code_binary(
        readed_file=file_read, extension=extension)
...
def read_and_decode(plain, cipher_instance, file_path):
    ...
    decoded_file, decoded_extension = cipher_instance.decode_binary(
        readed_file=file_read)
